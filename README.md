...
* [simulation_example_model_comparison](./simulation_example_model_comparison.py)
where the model class setups are found in [this](./model_example_compare_models.py) file.
