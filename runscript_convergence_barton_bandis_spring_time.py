...
# Subfolders
RESULTS_DIR = os.path.join(MAIN_RESULTS_DIR, "S_Lin_BB_time")
...
FIGURE_PATH = os.path.join(FIGURES_DIR, "convergence_nonlinear_spring_model_time.png")
