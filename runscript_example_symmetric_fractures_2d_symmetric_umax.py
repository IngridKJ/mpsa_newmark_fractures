...
if __name__ == "__main__":
    for u_max in [1.0e-5, 20 * 1.0e-5]:
        ...
        params = {
            ...
            "folder_name": f"simulation_example_symmetric_fractures_2d_umax_{u_max}",
            "grid_type": "simplex",
            "meshing_arguments": {
        ...
        model = CBB(params)
        model.results_dir = f"simulation_example_results_2d_umax_{u_max}"
        # other_params = {
        #     "progressbars": True,
